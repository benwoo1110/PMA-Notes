"""
Adapted from https://www.unknowncheats.me/forum/general-programming-and-reversing/343177-easy-nop-ida-plugin.html
"""
...
class EasyNopPlugin(idaapi.plugin_t):
    ...
    def init(self):
        ...
        AddToPopup('nopaction:add_action', 'Nop Selection', NopAction(), 'Shift+N', None)
...
class NopAction(EA_Action):
    def activate(self, ctx):
        ...
        result, start, end = idaapi.read_range_selection(None)
